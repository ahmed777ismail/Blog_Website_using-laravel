            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="{{ route('blogs.store') }}" class="form-contact contact_form" method="post"
                        ...
                        <div class="form-group">
                            <input class="form-control border" name="image" type="file" <x-input-error
                                :messages="$errors->get('image')" class="mt-2" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <textarea class="w-100 border" name="description" placeholder="Enter your Blog title" rows="5">{{ old('descriprion') }}
                            </textarea>
                            <x-input-error :messages="$errors->get('descriprion')" class="mt-2" />
                        </div>
